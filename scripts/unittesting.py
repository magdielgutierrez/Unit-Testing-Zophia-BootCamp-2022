...
class MyTestCase(unittest.TestCase):
    ...
    def test_int_favourites_count(self):
        self.assertIs(type(data_dict['data']['user']['result']['legacy']['favourites_count']), int)

    def test_int_followers_count(self):
        self.assertIs(type(data_dict['data']['user']['result']['legacy']['followers_count']), int)

    def test_int_friends_count(self):
        self.assertIs(type(data_dict['data']['user']['result']['legacy']['friends_count']), int)

    def test_int_listed_count(self):
        self.assertIs(type(data_dict['data']['user']['result']['legacy']['listed_count']), int)

    def test_int_media_count(self):
        self.assertIs(type(data_dict['data']['user']['result']['legacy']['media_count']), int)

    def test_int_normal_followers_count(self):
        self.assertIs(type(data_dict['data']['user']['result']['legacy']['normal_followers_count']), int)

    def test_int_statuses_count(self):
        self.assertIs(type(data_dict['data']['user']['result']['legacy']['statuses_count']), int)
